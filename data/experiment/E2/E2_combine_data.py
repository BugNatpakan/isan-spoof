...
root_output_dir = r"D:\work\AI frontier\project AntiSpoof\isan-spoof\data\experiment\E2"
DEST_FLAC_DIR = root_output_dir+r"\wav_all"
OUTPUT_METADATA_FILE = root_output_dir+r"\metadata.eval.txt"
OUTPUT_LST_FILE = root_output_dir+r"\scp\eval.lst"
