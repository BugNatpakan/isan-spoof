...
# for inference
# cd "D:\work\AI frontier\project AntiSpoof\isan-spoof\scripts" 
# python main.py --inference --model-forward-with-file-name --trained-model ../models/lcnn/ASVspoof2019LA/trained_network.pt --save-trained-name ../results/CSSbonafide_CSSspoof/eval_scores.txt --batch-size 1 > ../results/CSSbonafide_CSSspoof/eval_results_raw.txt
